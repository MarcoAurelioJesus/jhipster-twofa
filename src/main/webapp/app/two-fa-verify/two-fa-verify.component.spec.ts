...
describe('LoginComponent', () => {
  let comp: TwoFaVerifyComponent;
  let fixture: ComponentFixture<TwoFaVerifyComponent>;
  let mockRouter: Router;
  let mockAccountService: AccountService;
  let mockTwoFaVerifyService: TwoFaVerifyService;
  ...
  beforeEach(waitForAsync(() => {
    TestBed.configureTestingModule({
      ...
      .overrideTemplate(TwoFaVerifyComponent, '')
      .compileComponents();
  }));
  ...
  beforeEach(() => {
    ...
    mockTwoFaVerifyService = TestBed.inject(TwoFaVerifyService);
